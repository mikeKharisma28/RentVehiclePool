...
namespace RentVehiclePool.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(RentVehiclePoolContext context)
        {
            _context = context;
        }
        ...
        {
            var rentVehiclePoolContext = _context.Users.Include(u => u.Role);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RentVehiclePoolContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
